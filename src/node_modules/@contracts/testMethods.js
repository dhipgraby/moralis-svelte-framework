...
export async function getCatDetails(catId) {
    ...
    try {
        await contractData.interfaces.dragon.methods.getKitty(catId).call({},
...
export async function getAllYourCatIds() {
    ...
    try {
        let catIds = []
        await contractData.interfaces.dragon.methods.getAllYourKittyIds().call({}, function (err, idsTokens) {
            if (err){
                setAlert(error,'danger')
                return
            }   
